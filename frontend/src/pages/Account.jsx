    ...
    <>
      {user && (
        <>
        {
          ...
          :
          <div
          className="bg-gray-100 min-h-screen flex flex-col gap-4 items-center 
        ...
        >
         {
          ...
          <div className="bg-white  flex justify-between gap-4 p-8 rounded-lg shadow-md max-w-md">
            <div className="image flex flex-col justify-between mb-4 gap-4">
              ...
              type="file"
               ...
               required 
               /> 
              <button className="bg-blue-500 text-white px-3 py-2" onClick={changrImageHandler}>Update Profile</button>
            ...
            <div className="flex flex-col gap-2">
              {showInput? (
                ...
                className="text-gray-800 font-semibold ">
                  {user.name}
                  <button onClick={()=>setShowInput(true)}><CiEdit/></button>
                  </p>
          ...
          <button onClick={()=>setShowUpdatePass(!showUpdatePass)} className="bg-blue-500 px-2 py-1 rounded-sm  text-white">
           { showUpdatePass? "X": "Update Password"}
            ...
            {showUpdatePass &&(
             <form onSubmit={updatePassword} className="flex justify-center items-center  flex-col bg-white p-2 
             rounded-sm  gap-4">
              <input 
              type="password" 
              className="custom-input" 
            ...
            <>
              {myReels && myReels.length > 0 ? (
                <div className="flex gap-3 justify-center items-center">
                  ...
                  />
                  <div
                    className="button flex flex-col justify-center items-center gap-6"
                  >
                    {index === 0 ? (
                      ""
                    ) : (
