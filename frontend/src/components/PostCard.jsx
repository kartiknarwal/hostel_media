            ...
            <div className="md-4">
                {
                    ...
                    <button className='text-sm bg-red-500 text-white px-1 py-1 rounded-md' onClick={()=>setShowInput(false)}>X</button>
                    </>
                    :
                ...
                <div className="flex items-center space-x-2">
                    ...
                    >
                       ...
                       {isLike?<IoHeartSharp/> :<IoHeartOutline/> }
                        ...
                        <button className='hover:bg-gray-50 rounded-full p-'>
