  ...
  return (
    <div className='w-[100%] md:w-[750px] md:p-4'>
        <div className="flex gap-4 mx-auto">
            <div className="w-[30%]">
                <div className="top">
                    <button className='bg-blue-500 text-white px-3 py-1 rounded-full' onClick={()=>setSearch(!search)}>
                        {search?"X":<FaSearch/>}
                    </button>
                    {
                        search ? 
                           ...
                           <div className="users">
                            {
                                users && users.length > 0 ? users.map((e)=>(
                                    ...
                                    onClick={()=>createNewChat(e._id)}
                                     className="bg-gray-500 text-white p-2 mt-2 cursor-pointer flex justify-center 
                                     items-center gap-2"
                                     >
                                        <img 
